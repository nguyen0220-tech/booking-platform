...
@Component
public class SportFacilityHandler extends AbstractFacilityHandler {

    public SportFacilityHandler(FacilityRepository f, FacilityImageRepository i, ApplicationEventPublisher e) {
        super(f, i, e);
    }

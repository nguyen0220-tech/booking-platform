...
@Component
public class FacilityCarParkOption implements FacilityOptionHandler{
    @Override
    public FacilityOption getFacilityOption() {
        return FacilityOption.CAR_PARK;
    }
    ...
    public void setFacilityOption(Facility facility, OptionStateRequest request){
        ...
        if (facility.isCarPark() != targetState) {
            facility.setCarPark(targetState);
        }
    }
}
